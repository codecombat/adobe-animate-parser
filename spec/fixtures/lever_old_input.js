(function (cjs, an) {
    ...
    (lib.Tween3 = function(mode,startPosition,loop) {
        ...
        this.shape_1.graphics.f("#B3A382").s().p("AonOvQj+hNjEiOQjEiOhsi4Qhvi+AAjQQAAjPBvi/QBsi3DEiOQDEiOD+hNQEIhREfAAQEgAAEIBRQD+BNDECOQDECOBrC3QBwC/AADPQAADQhwC+QhrC4jECOQjECOj+BNQkIBRkgAAQkgAAkHhRg");
        this.shape_1.setTransform(-0.0217,-10.8146,0.2627,0.2627);
    
        this.shape_2 = new cjs.Shape();
        this.shape_2.graphics.f("#A1916A").s().p("AqNRfQkthcjpioQjpioiAjaQiEjiABj3QgBj2CEjiQCAjaDpioQDpioEthcQE4hfFVAAQFWAAE5BfQEtBcDoCoQDpCoB/DaQCEDiAAD2QAAD3iEDiQh/DajpCoQjoCoktBcQk5BflWAAQlVAAk4hfg");
    ...
    (lib.Tween2 = function(mode,startPosition,loop) {
        ...
        // Layer_1
        this.shape = new cjs.Shape();
        this.shape.graphics.f("#A9A59C").s().p("AkTEUQhxhzAAihQAAihBxhxQBzhzCgABQChgBByBzQBzBxgBChQABChhzBzQhyBxihABQiggBhzhxg");
        ...
        this.shape_4 = new cjs.Shape();
        this.shape_4.graphics.f("#B3A382").s().p("AoYCSQithPABhuQAAg1BAgyQBAgyBughIALgBIAACwIAZATQAjAWAwASQCVA8DTACQEYACCQhDQBIggAQgiIAEiMIACACQBWAgAwAoQAwAqABAtQAABtijBKQi8BWlhAFIglAAQk8AAi9hVg");
        ...
        this.shape_13.graphics.f("#5D442F").s().p("AmeFEQAdlrAPlWQFuBtF5hwQAOFgAbFiQjSA/jQAAQjNAAjNg9g");
        ...
        this.shape_15.graphics.f("#50321A").s().p("AmeVZQiRgqiQhKQA0lrAblKQA8rVg2qEQgak5g3ktQASA9BRAxQBMAsB8AdQCyAqDeAAQDhABCygrQB8gdBMguQBSgxAQhAQg1EvgaE8Qg1KHA6LSQAaFHAzFuQiOBHiUArQjSA+jQAAQjNAAjNg8g");
    ...
    (lib.Tween1 = function(mode,startPosition,loop) {
        ...
        // Layer_1
        this.shape = new cjs.Shape();
        this.shape.graphics.f("#7B7870").s().p("AikClQhEhEAAhhQAAhgBEhEQBFhEBfAAQBgAABFBEQBFBEAABgQAABhhFBEQhEBEhhAAQhfAAhFhEg");
        ...
        this.shape_2 = new cjs.Shape();
        this.shape_2.graphics.f("#B3A382").s().p("AonHbQj+hNjEiOQjEiOhsi2Qhvi/AAjQQAAgvAFgpIGLAAIAAAGQAABiAmBZQAkBWBDBDQBBBBBXAlQBYAmBiAAIP4AAQDHgBCLiLQCNiNAAjHIAAgGIHGAAQAFApAAAvQAADQhwC/QhrC2jECOQjECOj+BNQkIBRkgAAQkgAAkHhRg");
        this.shape_2.setTransform(-0.0217,-7.8277,0.2627,0.2627);
    
        this.shape_3 = new cjs.Shape();
        this.shape_3.graphics.f("#A1916A").s().p("AqNKQQkthcjpioQjpioiAjaQiEjhABj3QAAiTAviNIDdAAQgFApAAAvQAADQBvC+QBsC4DECNQDECOD+BNQEHBREgAAQEgAAEIhRQD+hNDEiOQDEiNBri4QBwi+AAjQQAAgvgFgpIDdAAQAwCNgBCTQAAD3iEDhQh/DajpCoQjoCokuBcQk4BflWAAQlVAAk4hfg");
        this.shape_3.setTransform(-0.0217,-2.6989,0.2627,0.2627);
    
        this.shape_4 = new cjs.Shape();
        this.shape_4.graphics.f("#756C57").s().p("ArFLtQlHhkj8i2Qj9i3iKjsQiPj0AAkMQAAjHBRi9IBtAAQgvCOAACSQgBD3CEDiQCADZDpCoQDpCoEtBcQE4BgFVAAQFWAAE4hgQEuhcDoioQDpioB/jZQCEjiAAj3QABiSgwiOIBuAAQBQC9AADHQAAEMiPD0QiKDsj9C3Qj8C2lIBkQlSBolzAAQlyAAlThog");
    ...
    // stage content:
    (lib.Town_Lever_Switch_Disabled_withBlue_01_JSCC = function(mode,startPosition,loop) {
        this.initialize(mode,startPosition,loop,{});
